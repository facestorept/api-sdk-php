...
/**
 * ProductsDiscountsApiTest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductsDiscountsApiTest extends \PHPUnit_Framework_TestCase
{
    ...
    private static $productDiscount;
    private static $productDiscountId;
...
//        $i18n->setSeo($seo);
    ...
    /**
     * Test case for addProductDiscount
     *
     * .
     *
     */
    public function testAddProductDiscount()
    {
        ...
        self::$productDiscount = new ProductsDiscountsApi(
            new Client(),
            self::$config
        );

        $response = self::$productDiscount->addProductDiscount(self::$resourceId, $discount);
    ...
    /**
     * Test case for getProductDiscounts
     *
     * .
     *
     */
    ...
    /**
     * Test case for getProductDiscountsByID
     *
     * .
     *
     */
    public function testGetProductDiscountsByID()
    {
    ...
    /**
     * Test case for updateProductDiscountById
     *
     * .
     *
     */
    public function testUpdateProductDiscountById()
    {
        $discount = new Model\Discount();
        $discount->setActive(true);
        ...
        self::$productDiscount->updateProductDiscountById(self::$resourceId ,self::$productDiscountId, $discount);

        $discountResponse = self::$productDiscount->getProductDiscountsByID(self::$resourceId, self::$productDiscountId);

        $discount = $discountResponse->getData()[0];

        $this->assertEquals(50, $discount->getDiscountPercentage());
    }

    /**
     * Test case for deleteProductDiscountById
     *
     * .
     *
     */
    public function testDeleteProductDiscountById()
    {
        $this->setExpectedException(ApiException::class, null,404);

        self::$productDiscount->deleteProductDiscountById(self::$resourceId, self::$productDiscountId);

        self::$productDiscount->getProductDiscountsByID(self::$resourceId, self::$productDiscountId);
    }
}
