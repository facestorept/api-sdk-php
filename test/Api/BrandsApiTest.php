...
class BrandsApiTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $brand = new Brand();
        $brand->setVisibility([Model\Brand::VISIBILITY_FACEBOOK, Model\Brand::VISIBILITY_MOBILE]);
    ...
    {
        $brands = $this->brandsAPI->getBrandById($this->resourceId);
     ...
     *
     */
    public function testUpdateBrandById()
    {
    ...
    public function testUploadImagesBrand()
    {
        ...
        $defaultAPI->uploadImages(
            837,
            '/var/www/api-sdks/php/SwaggerClient-php/test/Api/image.jpg',
            '/var/www/api-sdks/php/SwaggerClient-php/test/Api/image.jpg'
        );

        $brandResponse = $this->brandsAPI->getBrandById(837);

        $imageSmall = $brandResponse->getData()[0]->getImageSmall();
