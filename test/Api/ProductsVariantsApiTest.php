...
/**
 * ProductsVariantsApiTest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductsVariantsApiTest extends \PHPUnit_Framework_TestCase
{
...
//        $i18n->setSeo($seo);
    ...
    /**
     * Test case for addProductVariant
     *
     * .
     *
     */
    public function testAddProductVariant()
    {
        ...
        $response = self::$productVariant->addProductVariant(self::$resourceId, $variant);
    ...
    /**
     * Test case for getProductVariants
     *
     * .
     *
     */
    ...
    /**
     * Test case for getProductVariantsByID
     *
     * .
     *
     */
    public function testGetProductVariantsByID()
    {
    ...
    /**
     * Test case for updateProductVariantsById
     *
     * .
     *
     */
    public function testUpdateProductVariantsById()
    {
        $variantSku = 'Vaqq1111ndft Sku';
        ...
        self::$productVariant->updateProductVariantsById(self::$resourceId, self::$productVariantId, $variant);

        $discountResponse = self::$productVariant->getProductVariantsByID(self::$resourceId, self::$productVariantId);

        $variant = $discountResponse->getData()[0];

        $this->assertEquals($variantSku, $variant->getSku());
    }

    /**
     * Test case for deleteProductVariantById
     *
     * .
     *
     */
    public function testDeleteProductVariantById()
    {
        $this->setExpectedException(ApiException::class, null,404);

        self::$productVariant->deleteProductVariantById(self::$resourceId, self::$productVariantId);

        self::$productVariant->getProductVariantsById(self::$resourceId, self::$productVariantId);
    }
