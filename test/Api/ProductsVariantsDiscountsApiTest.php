<?php
/**
 * ProductsVariantsDiscountsApiTest
 * PHP version 5
 *
 * @category Class
...
use Swagger\Client\Api\ProductsVariantsDiscountsApi;
...
/**
 * ProductsVariantsDiscountsApiTest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductsVariantsDiscountsApiTest extends \PHPUnit_Framework_TestCase
{
    ...
    private static $productVariantDiscount;
    private static $productVariantDiscountId;
...
//        $i18n->setSeo($seo);
        ...
        $responseProduct = self::$resourceAPI->addProduct($product);
        ...
        $variantPrice = new Model\ProductPrices();
        $variantPrice->setPrice(137);

        $variant->setPrices($variantPrice);

        self::$productVariant = new ProductsVariantsApi(
            new Client(),
            self::$config
        );

        $responseVariant = self::$productVariant->addProductVariant(self::$resourceId, $variant);

        self::$productVariantId = $responseVariant->getData()[0]->getId();
    }
    ...
    /**
     * Test case for addProductVariantDiscount
     *
     * .
     *
     */
    public function testAddProductVariantDiscount()
    {
        $discount = new Model\VariantDiscount();
        $discount->setActive(true);
        $discount->setDiscountPercentage(30);
        $discount->setIdProducts(self::$resourceId);
        $discount->setIdVariant(self::$productVariantId);

        $discountBeginDate = new \DateTime();
        $discountBeginDate->setDate(2021,03,14);
        $discountEndDate = new \DateTime();
        $discountEndDate->setDate(2021,04,14);

        $discount->setBeginAt($discountBeginDate);
        $discount->setEndAt($discountEndDate);

        self::$productVariantDiscount = new ProductsVariantsDiscountsApi(
            new Client(),
            self::$config
        );

        $response = self::$productVariantDiscount->addProductVariantDiscount(self::$resourceId, self::$productVariantId, $discount);
    ...
    /**
     * Test case for getProductVariantsDiscounts
     *
     * .
     *
     */
    public function testGetProductVariantsDiscounts()
    {
    ...
    /**
     * Test case for getProductVariantsDiscountsByID
     *
     * .
     *
     */
    public function testGetProductVariantsDiscountsByID()
    {
    ...
    /**
     * Test case for updateProductVariantsDiscountsById
     *
     * .
     *
     */
    public function testUpdateProductVariantsDiscountsById()
    {
        $discount = new Model\VariantDiscount();
        $discount->setActive(true);
        $discount->setDiscountPercentage(30);
        ...
        $discountBeginDate = new \DateTime();
        $discountBeginDate->setDate(2022,03,14);
        $discountEndDate = new \DateTime();
        $discountEndDate->setDate(2022,04,14);
        ...
        self::$productVariantDiscount->updateProductVariantsDiscountsById(self::$resourceId ,self::$productVariantId, self::$productVariantDiscountId);

        $discountResponse = self::$productVariantDiscount->getProductVariantsDiscountsByID(self::$resourceId, self::$productVariantId, self::$productVariantDiscountId);

        $discount = $discountResponse->getData()[0];

        $this->assertEquals(30, $discount->getDiscountPercentage());
    }

    /**
     * Test case for deleteProductVariantDiscountById
     *
     * .
     *
     */
    public function testDeleteProductVariantDiscountById()
    {
        $this->setExpectedException(ApiException::class, null,404);

        self::$productVariantDiscount->deleteProductVariantDiscountById(self::$resourceId, self::$productVariantId, self::$productVariantDiscountId);

        self::$productVariantDiscount->getProductVariantsDiscountsByID(self::$resourceId, self::$productVariantId, self::$productVariantDiscountId);
    }
}
