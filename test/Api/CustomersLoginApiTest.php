...
use Swagger\Client\Api\CustomersLoginApi;
use \Swagger\Client\Configuration;
use \Swagger\Client\ApiException;
use Swagger\Client\Model\Customer;
use Swagger\Client\Model\CustomerLogin;
use \Swagger\Client\ObjectSerializer;

/**
 * CustomersLoginApiTest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CustomersLoginApiTest extends \PHPUnit_Framework_TestCase
{
    private static $config;
    /**
     * @var Api\CustomersLoginApi
     */
    private static $resourceAPI;
    private static $resourceLogin;
    ...
    public static function setUpBeforeClass()
    {
        ...
        $customer->setEmail('rqvb111gw23@gmail.com');
    ...
    public function testCustomerLogin()
    {
        ...
        $customerLogin->setEmail('rqvb111gw23@gmail.com');
        ...
        self::$resourceLogin->customerLogin($customerLogin);
    }
}
