...
class CategoriesApiTest extends PHPUnit_Framework_TestCase
{
    ...
    public function tearDown()
    {
        ...
        $this->categoriesAPI->deleteCategoryById($response->getData()[0]->getId());
    }
    ...
    public function testAddFullCategoriesWithImagesWithSuccess()
    {
        ...
        $response = $this->categoriesAPI->addCategory($category);
    ...
    {
        $category = $this->categoriesAPI->getCategoryById($this->idCategory);
