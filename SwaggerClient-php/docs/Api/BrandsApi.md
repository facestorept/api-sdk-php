...
try {
    $api_instance->deleteBrandById($id);
} catch (Exception $e) {
...
try {
    $result = $api_instance->getBrandById($id, $includes, $limit);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $api_instance->getBrands($includes, $limit, $order_by);
    print_r($result);
} catch (Exception $e) {
...
try {
    $api_instance->updateBrandsById($id, $brand);
} catch (Exception $e) {
