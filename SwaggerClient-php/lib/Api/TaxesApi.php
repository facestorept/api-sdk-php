...
class TaxesApi
{
    ...
    public function addTaxesWithHttpInfo($tax)
    {
        ...
        if ($tax === null) {
            throw new \InvalidArgumentException('Missing the required parameter $tax when calling addTaxes');
        }
        // parse inputs
        $resourcePath = "/taxes";
        $httpBody = '';
    ...
    {
        list($response) = $this->deleteTaxByIdWithHttpInfo($id);
        return $response;
    }
    ...
    public function deleteTaxByIdWithHttpInfo($id)
    {
        ...
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling deleteTaxById');
        }
        // parse inputs
    ...
    public function getTaxByIdWithHttpInfo($id, $includes = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling getTaxById');
        }
        // parse inputs
        $resourcePath = "/taxes/{id}/";
        $httpBody = '';
    ...
    public function updateTaxByIdWithHttpInfo($id, $tax)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling updateTaxById');
        }
        // verify the required parameter 'tax' is set
        if ($tax === null) {
            throw new \InvalidArgumentException('Missing the required parameter $tax when calling updateTaxById');
        }
        // parse inputs
        $resourcePath = "/taxes/{id}/";
        $httpBody = '';
