...
class Variant implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'id' => 'int',
        'attributes' => '\Swagger\Client\Model\VariantAttributes[]',
        'sku' => 'string',
        'quantity' => 'int',
        'active' => 'bool',
     ...
     * Gets attributes
     *
     * @return \Swagger\Client\Model\VariantAttributes[]
     */
     ...
     * Sets attributes
     *
     * @param \Swagger\Client\Model\VariantAttributes[] $attributes attributes
     *
     * @return $this
     */
     ...
     * Sets sku
     *
     * @param string $sku Sku of a variant
     *
     * @return $this
     */
