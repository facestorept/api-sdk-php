...
class Options implements ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['aux_code'] = isset($data['aux_code']) ? $data['aux_code'] : null;
    ...
    {
        return $this->container['aux_code'];
    }

    /**
     * Sets aux_code
     * @param string $aux_code
     * @return $this
     */
    public function setAuxCode($aux_code)
    {
        $this->container['aux_code'] = $aux_code;
    ...
    /**
     * Sets i18n
     * @param \Swagger\Client\Model\I18n $i18n
     * @return $this
     */
