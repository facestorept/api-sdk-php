...
/**
 * ProductsVariantsApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class ProductsVariantsApi
{
     ...
     * @param  \Swagger\Client\Model\Variant $variant Product variant to add to the store (required)
     *
    ...
    {
        list($response) = $this->addProductVariantWithHttpInfo($id, $variant);
        return $response;
    }
     ...
     */
    public function addProductVariantAsync($id, $variant)
    {
        return $this->addProductVariantAsyncWithHttpInfo($id, $variant)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function addProductVariantRequest($id, $variant)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling addProductVariant'
            );
        }
        // verify the required parameter 'variant' is set
        if ($variant === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $variant when calling addProductVariant'
            );
        }

        $resourcePath = '/products/{id}/variants/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation deleteProductVariantById
     *
     * @param  int $id ID of product variant to delete (required)
     * @param  int $id_variant ID of product variant to delete (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function deleteProductVariantById($id, $id_variant)
    {
        $this->deleteProductVariantByIdWithHttpInfo($id, $id_variant);
    }

    /**
     * Operation deleteProductVariantByIdWithHttpInfo
     *
     * @param  int $id ID of product variant to delete (required)
     * @param  int $id_variant ID of product variant to delete (required)
     *
     ...
     */
    public function deleteProductVariantByIdWithHttpInfo($id, $id_variant)
    {
        $returnType = '';
        $request = $this->deleteProductVariantByIdRequest($id, $id_variant);
    ...
    /**
     * Operation deleteProductVariantByIdAsync
     *
     * 
     *
     * @param  int $id ID of product variant to delete (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteProductVariantByIdAsync($id, $id_variant)
    {
        return $this->deleteProductVariantByIdAsyncWithHttpInfo($id, $id_variant)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteProductVariantByIdAsyncWithHttpInfo
     *
     * 
     *
     * @param  int $id ID of product variant to delete (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteProductVariantByIdAsyncWithHttpInfo($id, $id_variant)
    {
        $returnType = '';
        $request = $this->deleteProductVariantByIdRequest($id, $id_variant);
    ...
    /**
     * Create request for operation 'deleteProductVariantById'
     *
     * @param  int $id ID of product variant to delete (required)
     * @param  int $id_variant ID of product variant to delete (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteProductVariantByIdRequest($id, $id_variant)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling deleteProductVariantById'
            );
        }
        // verify the required parameter 'id_variant' is set
        if ($id_variant === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id_variant when calling deleteProductVariantById'
            );
        }

        $resourcePath = '/products/{id}/variants/{id_variant}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->getProductVariantsWithHttpInfo($id);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductVariantsAsync($id)
    {
        return $this->getProductVariantsAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getProductVariantsRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getProductVariants'
            );
        }
    ...
    /**
     * Operation getProductVariantsByID
     *
     * @param  int $id ID of product to get (required)
     * @param  int $id_variant ID of disocunt to get (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->getProductVariantsByIDWithHttpInfo($id, $id_variant);
        return $response;
    }

    /**
     * Operation getProductVariantsByIDWithHttpInfo
     *
     * @param  int $id ID of product to get (required)
     * @param  int $id_variant ID of disocunt to get (required)
     *
    ...
    /**
     * Operation getProductVariantsByIDAsync
     *
     * 
     *
     * @param  int $id ID of product to get (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductVariantsByIDAsync($id, $id_variant)
    {
        return $this->getProductVariantsByIDAsyncWithHttpInfo($id, $id_variant)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getProductVariantsByIDAsyncWithHttpInfo
     *
     * 
     *
     * @param  int $id ID of product to get (required)
    ...
    /**
     * Create request for operation 'getProductVariantsByID'
     *
     * @param  int $id ID of product to get (required)
     * @param  int $id_variant ID of disocunt to get (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getProductVariantsByIDRequest($id, $id_variant)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getProductVariantsByID'
            );
        }
        // verify the required parameter 'id_variant' is set
        if ($id_variant === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id_variant when calling getProductVariantsByID'
            );
        }
    ...
    /**
     * Operation updateProductVariantsById
     *
     * @param  int $id ID of product variant to update (required)
     * @param  int $id_variant Product variant to add to the store (required)
     * @param  \Swagger\Client\Model\Variant $variant Product variant to update (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function updateProductVariantsById($id, $id_variant, $variant)
    {
        $this->updateProductVariantsByIdWithHttpInfo($id, $id_variant, $variant);
    }

    /**
     * Operation updateProductVariantsByIdWithHttpInfo
     *
     * @param  int $id ID of product variant to update (required)
     * @param  int $id_variant Product variant to add to the store (required)
     * @param  \Swagger\Client\Model\Variant $variant Product variant to update (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateProductVariantsByIdWithHttpInfo($id, $id_variant, $variant)
    {
        $returnType = '';
        $request = $this->updateProductVariantsByIdRequest($id, $id_variant, $variant);
    ...
    /**
     * Operation updateProductVariantsByIdAsync
     *
     * 
     *
     * @param  int $id ID of product variant to update (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateProductVariantsByIdAsync($id, $id_variant, $variant)
    {
        return $this->updateProductVariantsByIdAsyncWithHttpInfo($id, $id_variant, $variant)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateProductVariantsByIdAsyncWithHttpInfo
     *
     * 
     *
     * @param  int $id ID of product variant to update (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateProductVariantsByIdAsyncWithHttpInfo($id, $id_variant, $variant)
    {
        $returnType = '';
        $request = $this->updateProductVariantsByIdRequest($id, $id_variant, $variant);
    ...
    /**
     * Create request for operation 'updateProductVariantsById'
     *
     * @param  int $id ID of product variant to update (required)
     * @param  int $id_variant Product variant to add to the store (required)
     * @param  \Swagger\Client\Model\Variant $variant Product variant to update (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateProductVariantsByIdRequest($id, $id_variant, $variant)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling updateProductVariantsById'
            );
        }
        // verify the required parameter 'id_variant' is set
        if ($id_variant === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id_variant when calling updateProductVariantsById'
            );
        }
        // verify the required parameter 'variant' is set
        if ($variant === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $variant when calling updateProductVariantsById'
            );
        }
