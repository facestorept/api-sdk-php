...
class ProductsApi
{
    ...
    public function addProductWithHttpInfo($product)
    {
        ...
        if ($product === null) {
            throw new \InvalidArgumentException('Missing the required parameter $product when calling addProduct');
        }
        // parse inputs
    ...
    {
        list($response) = $this->deleteProductByIdWithHttpInfo($id);
        return $response;
    }
    ...
    public function deleteProductByIdWithHttpInfo($id)
    {
        ...
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling deleteProductById');
        }
        // parse inputs
    ...
    {
        list($response) = $this->updateProductByIdWithHttpInfo($id, $tax);
        return $response;
    }
    ...
    public function updateProductByIdWithHttpInfo($id, $tax)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling updateProductById');
        }
        // verify the required parameter 'tax' is set
        if ($tax === null) {
            throw new \InvalidArgumentException('Missing the required parameter $tax when calling updateProductById');
        }
        // parse inputs
        $resourcePath = "/products/{id}/";
        $httpBody = '';
    ...
    {
        list($response) = $this->updateProductById_0WithHttpInfo($id, $tax);
        return $response;
    }
    ...
    public function updateProductById_0WithHttpInfo($id, $tax)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling updateProductById_0');
        }
        // verify the required parameter 'tax' is set
        if ($tax === null) {
            throw new \InvalidArgumentException('Missing the required parameter $tax when calling updateProductById_0');
        }
        // parse inputs
        $resourcePath = "/products/{id}/";
        $httpBody = '';
