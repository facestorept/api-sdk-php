...
class ProductsApi
{
    ...
    {
        list($response) = $this->addProductWithHttpInfo($product);
        return $response;
    }
     ...
     */
    public function addProductAsync($product)
    {
        return $this->addProductAsyncWithHttpInfo($product)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function addProductRequest($product)
    {
        // verify the required parameter 'product' is set
        if ($product === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $product when calling addProduct'
            );
        }
    ...
    {
        $this->deleteProductByIdWithHttpInfo($id);
    }
     ...
     */
    public function deleteProductByIdWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->deleteProductByIdRequest($id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteProductByIdAsync($id)
    {
        return $this->deleteProductByIdAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteProductByIdAsyncWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->deleteProductByIdRequest($id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteProductByIdRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling deleteProductById'
            );
        }
    ...
    {
        list($response) = $this->getProductByIdWithHttpInfo($id, $includes, $limit);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductByIdAsync($id, $includes = null, $limit = null)
    {
        return $this->getProductByIdAsyncWithHttpInfo($id, $includes, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getProductByIdRequest($id, $includes = null, $limit = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
     ...
     *
     * @param  int $id ID of productImage to get (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
    ...
    {
        $this->getProductImagesWithHttpInfo($id);
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductImagesAsync($id)
    {
        return $this->getProductImagesAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getProductImagesRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
    ...
    /**
     * Operation getProductImagesById
     *
     * Get images for product
     *
     * @param  int $id ID of product to get (required)
    ...
    {
        $this->getProductImagesByIdWithHttpInfo($id, $id_image);
    }

    /**
     * Operation getProductImagesByIdWithHttpInfo
     *
     * Get images for product
     *
     * @param  int $id ID of product to get (required)
    ...
    /**
     * Operation getProductImagesByIdAsync
     *
     * Get images for product
     *
     * @param  int $id ID of product to get (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductImagesByIdAsync($id, $id_image)
    {
        return $this->getProductImagesByIdAsyncWithHttpInfo($id, $id_image)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getProductImagesByIdAsyncWithHttpInfo
     *
     * Get images for product
     *
     * @param  int $id ID of product to get (required)
    ...
    /**
     * Create request for operation 'getProductImagesById'
     *
     * @param  int $id ID of product to get (required)
     * @param  int $id_image ID of productImage to get (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getProductImagesByIdRequest($id, $id_image)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getProductImagesById'
            );
        }
        // verify the required parameter 'id_image' is set
        if ($id_image === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id_image when calling getProductImagesById'
            );
        }
    ...
    {
        list($response) = $this->getProductsWithHttpInfo($includes, $limit, $order_by);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductsAsync($includes = null, $limit = null, $order_by = null)
    {
        return $this->getProductsAsyncWithHttpInfo($includes, $limit, $order_by)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getProductsRequest($includes = null, $limit = null, $order_by = null)
    {
     ...
     * @return void
     */
    public function updateProductById($id, $tax)
    {
        $this->updateProductByIdWithHttpInfo($id, $tax);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateProductByIdWithHttpInfo($id, $tax)
    {
        $returnType = '';
        $request = $this->updateProductByIdRequest($id, $tax);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateProductByIdAsync($id, $tax)
    {
        return $this->updateProductByIdAsyncWithHttpInfo($id, $tax)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateProductByIdAsyncWithHttpInfo($id, $tax)
    {
        $returnType = '';
        $request = $this->updateProductByIdRequest($id, $tax);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateProductByIdRequest($id, $tax)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling updateProductById'
            );
        }
        // verify the required parameter 'tax' is set
        if ($tax === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $tax when calling updateProductById'
            );
        }
    ...
    /**
     * Operation uploadProductsImages
     *
     ...
     */
    public function uploadProductsImages($id, $files = null)
    {
        list($response) = $this->uploadProductsImagesWithHttpInfo($id, $files);
        return $response;
    }

    /**
     * Operation uploadProductsImagesWithHttpInfo
     *
     * Upload de images for product
     *
     * @param  int $id ID of product to update (required)
     ...
     */
    public function uploadProductsImagesWithHttpInfo($id, $files = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2015';
        $request = $this->uploadProductsImagesRequest($id, $files);
    ...
    /**
     * Operation uploadProductsImagesAsync
     *
     * Upload de images for product
     *
     * @param  int $id ID of product to update (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadProductsImagesAsync($id, $files = null)
    {
        return $this->uploadProductsImagesAsyncWithHttpInfo($id, $files)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation uploadProductsImagesAsyncWithHttpInfo
     *
     * Upload de images for product
     *
     * @param  int $id ID of product to update (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadProductsImagesAsyncWithHttpInfo($id, $files = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2015';
        $request = $this->uploadProductsImagesRequest($id, $files);
    ...
    /**
     * Create request for operation 'uploadProductsImages'
     *
     * @param  int $id ID of product to update (required)
     * @param  \SplFileObject $files File for product (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function uploadProductsImagesRequest($id, $files = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling uploadProductsImages'
            );
        }
