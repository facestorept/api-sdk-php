...
class CategoriesApi
{
    ...
    public function addCategoriesWithHttpInfo($category)
    {
        ...
        if ($category === null) {
            throw new \InvalidArgumentException('Missing the required parameter $category when calling addCategories');
        }
        // parse inputs
    ...
    {
        list($response) = $this->deleteCategoryByIdWithHttpInfo($id);
        return $response;
    }
    ...
    public function deleteCategoryByIdWithHttpInfo($id)
    {
        ...
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling deleteCategoryById');
        }
        // parse inputs
    ...
    public function getCategoryByIdWithHttpInfo($id, $includes = null, $limit = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling getCategoryById');
        }
        // parse inputs
        $resourcePath = "/categories/{id}/";
        $httpBody = '';
    ...
    {
        list($response) = $this->updateCategoryByIdWithHttpInfo($id, $category);
        return $response;
    }
    ...
    public function updateCategoryByIdWithHttpInfo($id, $category)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling updateCategoryById');
        }
        // verify the required parameter 'category' is set
        if ($category === null) {
            throw new \InvalidArgumentException('Missing the required parameter $category when calling updateCategoryById');
        }
        // parse inputs
        $resourcePath = "/categories/{id}/";
        $httpBody = '';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 404:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\NotFoundResponse[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
