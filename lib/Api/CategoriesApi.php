...
class CategoriesApi
{
     ...
     *
     * @param  \Swagger\Client\Model\Category $category Category to add to the store (required)
     *
    ...
    {
        list($response) = $this->addCategoriesWithHttpInfo($category);
        return $response;
    }

    /**
     * Operation addCategoriesWithHttpInfo
     *
     * @param  \Swagger\Client\Model\Category $category Category to add to the store (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     ...
     */
    public function addCategoriesWithHttpInfo($category)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2011';
        $request = $this->addCategoriesRequest($category);
     ...
     */
    public function addCategoriesAsync($category)
    {
        return $this->addCategoriesAsyncWithHttpInfo($category)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation addCategoriesAsyncWithHttpInfo
     *
     * 
     *
     * @param  \Swagger\Client\Model\Category $category Category to add to the store (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addCategoriesAsyncWithHttpInfo($category)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2011';
        $request = $this->addCategoriesRequest($category);
    ...
    /**
     * Create request for operation 'addCategories'
     *
     * @param  \Swagger\Client\Model\Category $category Category to add to the store (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function addCategoriesRequest($category)
    {
        // verify the required parameter 'category' is set
        if ($category === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $category when calling addCategories'
            );
        }
     ...
     *
     * @param  int $id ID of category to delete (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
    ...
    {
        $this->deleteCategoryByIdWithHttpInfo($id);
    }
     ...
     */
    public function deleteCategoryByIdWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->deleteCategoryByIdRequest($id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteCategoryByIdAsync($id)
    {
        return $this->deleteCategoryByIdAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteCategoryByIdAsyncWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->deleteCategoryByIdRequest($id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteCategoryByIdRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling deleteCategoryById'
            );
        }
     ...
     */
    public function getCategories($includes = null, $limit = null, $order_by = null)
    {
        list($response) = $this->getCategoriesWithHttpInfo($includes, $limit, $order_by);
        return $response;
    }
     ...
     */
    public function getCategoriesWithHttpInfo($includes = null, $limit = null, $order_by = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2001';
        $request = $this->getCategoriesRequest($includes, $limit, $order_by);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCategoriesAsync($includes = null, $limit = null, $order_by = null)
    {
        return $this->getCategoriesAsyncWithHttpInfo($includes, $limit, $order_by)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCategoriesAsyncWithHttpInfo($includes = null, $limit = null, $order_by = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2001';
        $request = $this->getCategoriesRequest($includes, $limit, $order_by);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCategoriesRequest($includes = null, $limit = null, $order_by = null)
    {
     ...
     *
     * @param  int $id ID of category to fetch (required)
     * @param  string[] $includes Include associated objects within response (optional)
     * @param  int $limit max records to return (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     ...
     * @return \Swagger\Client\Model\InlineResponse2011
     */
    public function getCategoryById($id, $includes = null, $limit = null)
    {
        list($response) = $this->getCategoryByIdWithHttpInfo($id, $includes, $limit);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\InlineResponse2011, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCategoryByIdWithHttpInfo($id, $includes = null, $limit = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2011';
        $request = $this->getCategoryByIdRequest($id, $includes, $limit);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCategoryByIdAsync($id, $includes = null, $limit = null)
    {
        return $this->getCategoryByIdAsyncWithHttpInfo($id, $includes, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCategoryByIdAsyncWithHttpInfo($id, $includes = null, $limit = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2011';
        $request = $this->getCategoryByIdRequest($id, $includes, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCategoryByIdRequest($id, $includes = null, $limit = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getCategoryById'
            );
        }
     ...
     * @param  object $category Category to update in store (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
    ...
    {
        $this->updateCategoryByIdWithHttpInfo($id, $category);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateCategoryByIdWithHttpInfo($id, $category)
    {
        $returnType = '';
        $request = $this->updateCategoryByIdRequest($id, $category);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCategoryByIdAsync($id, $category)
    {
        return $this->updateCategoryByIdAsyncWithHttpInfo($id, $category)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCategoryByIdAsyncWithHttpInfo($id, $category)
    {
        $returnType = '';
        $request = $this->updateCategoryByIdRequest($id, $category);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateCategoryByIdRequest($id, $category)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling updateCategoryById'
            );
        }
        // verify the required parameter 'category' is set
        if ($category === null) {
