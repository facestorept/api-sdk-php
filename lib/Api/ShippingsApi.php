...
class ShippingsApi
{
     ...
     */
    public function addShippingAsync($shipping)
    {
        return $this->addShippingAsyncWithHttpInfo($shipping)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation addShippingAsyncWithHttpInfo
     *
     * 
     *
     * @param  \Swagger\Client\Model\Shipping $shipping Shipping to add to the store (required)
    ...
    /**
     * Create request for operation 'addShipping'
     *
     * @param  \Swagger\Client\Model\Shipping $shipping Shipping to add to the store (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function addShippingRequest($shipping)
    {
        // verify the required parameter 'shipping' is set
        if ($shipping === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $shipping when calling addShipping'
            );
        }
    ...
    {
        $this->deleteShippingByIdWithHttpInfo($id);
    }
    ...
    {
        $returnType = '';
        $request = $this->deleteShippingByIdRequest($id);
    ...
    /**
     * Operation deleteShippingByIdAsync
     *
     * 
     *
     * @param  int $id ID of shipping to delete (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteShippingByIdAsync($id)
    {
        return $this->deleteShippingByIdAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteShippingByIdAsyncWithHttpInfo
     *
     * 
     *
     * @param  int $id ID of shipping to delete (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteShippingByIdAsyncWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->deleteShippingByIdRequest($id);
    ...
    /**
     * Create request for operation 'deleteShippingById'
     *
     * @param  int $id ID of shipping to delete (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteShippingByIdRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling deleteShippingById'
            );
        }
    ...
    /**
     * Operation getShippingByIdAsync
     *
     * 
     *
     * @param  int $id ID of shipping to fetch (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getShippingByIdAsync($id, $includes = null)
    {
        return $this->getShippingByIdAsyncWithHttpInfo($id, $includes)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getShippingByIdAsyncWithHttpInfo
     *
     * 
     *
     * @param  int $id ID of shipping to fetch (required)
    ...
    /**
     * Create request for operation 'getShippingById'
     *
     * @param  int $id ID of shipping to fetch (required)
     * @param  string[] $includes Include associated objects within response (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getShippingByIdRequest($id, $includes = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getShippingById'
            );
        }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getShippingsAsync($includes = null, $limit = null, $order_by = null)
    {
        return $this->getShippingsAsyncWithHttpInfo($includes, $limit, $order_by)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getShippingsRequest($includes = null, $limit = null, $order_by = null)
    {
    ...
    /**
     * Operation updateShippingByIdAsync
     *
     * 
     *
     * @param  int $id ID of shipping to update (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateShippingByIdAsync($id, $tax)
    {
        return $this->updateShippingByIdAsyncWithHttpInfo($id, $tax)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateShippingByIdAsyncWithHttpInfo
     *
     * 
     *
     * @param  int $id ID of shipping to update (required)
    ...
    /**
     * Create request for operation 'updateShippingById'
     *
     * @param  int $id ID of shipping to update (required)
     * @param  \Swagger\Client\Model\Shipping $tax Shipping to update in store (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateShippingByIdRequest($id, $tax)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling updateShippingById'
            );
        }
        // verify the required parameter 'tax' is set
        if ($tax === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $tax when calling updateShippingById'
            );
        }
    ...
    /**
     * Operation updateShippingById_0
     *
     * @param  int $id ID of shipping to update (required)
     * @param  \Swagger\Client\Model\Shipping $tax Shipping to update in store (required)
     *
     ...
     * @return \Swagger\Client\Model\InlineResponse2013
     */
    public function updateShippingById_0($id, $tax)
    {
        list($response) = $this->updateShippingById_0WithHttpInfo($id, $tax);
        return $response;
    }

    /**
     * Operation updateShippingById_0WithHttpInfo
     *
     * @param  int $id ID of shipping to update (required)
     * @param  \Swagger\Client\Model\Shipping $tax Shipping to update in store (required)
     *
     ...
     * @return array of \Swagger\Client\Model\InlineResponse2013, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateShippingById_0WithHttpInfo($id, $tax)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2013';
        $request = $this->updateShippingById_0Request($id, $tax);
    ...
    /**
     * Operation updateShippingById_0Async
     *
     * 
     *
     * @param  int $id ID of shipping to update (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateShippingById_0Async($id, $tax)
    {
        return $this->updateShippingById_0AsyncWithHttpInfo($id, $tax)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateShippingById_0AsyncWithHttpInfo
     *
     * 
     *
     * @param  int $id ID of shipping to update (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateShippingById_0AsyncWithHttpInfo($id, $tax)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2013';
        $request = $this->updateShippingById_0Request($id, $tax);
    ...
    /**
     * Create request for operation 'updateShippingById_0'
     *
     * @param  int $id ID of shipping to update (required)
     * @param  \Swagger\Client\Model\Shipping $tax Shipping to update in store (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateShippingById_0Request($id, $tax)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling updateShippingById_0'
            );
        }
        // verify the required parameter 'tax' is set
        if ($tax === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $tax when calling updateShippingById_0'
            );
        }
