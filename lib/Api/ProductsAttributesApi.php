...
class ProductsAttributesApi
{
    ...
    public function addProductsAttributesWithHttpInfo($attribute)
    {
        ...
        if ($attribute === null) {
            throw new \InvalidArgumentException('Missing the required parameter $attribute when calling addProductsAttributes');
        }
        // parse inputs
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\Attribute[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\Attribute[]', $e->getResponseHeaders());
    ...
    {
        list($response) = $this->deleteProductAttributeByIdWithHttpInfo($id);
        return $response;
    }
    ...
    public function deleteProductAttributeByIdWithHttpInfo($id)
    {
        ...
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling deleteProductAttributeById');
        }
        // parse inputs
    ...
    public function getProductAttributeByIdWithHttpInfo($id, $includes = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling getProductAttributeById');
        }
        // parse inputs
        $resourcePath = "/attributes/{id}/";
        $httpBody = '';
    ...
    public function updateProductAttributeByIdWithHttpInfo($id, $product_attribute)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling updateProductAttributeById');
        }
        // verify the required parameter 'product_attribute' is set
        if ($product_attribute === null) {
            throw new \InvalidArgumentException('Missing the required parameter $product_attribute when calling updateProductAttributeById');
        }
        // parse inputs
        $resourcePath = "/attributes/{id}/";
        $httpBody = '';
