...
class BrandsApi
{
    ...
    public function addBrandsWithHttpInfo($brand)
    {
        ...
        if ($brand === null) {
            throw new \InvalidArgumentException('Missing the required parameter $brand when calling addBrands');
        }
        // parse inputs
        $resourcePath = "/brands";
        $httpBody = '';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    ...
                    break;
                case 422:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\InlineResponse422', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
    ...
    {
        list($response) = $this->deleteBrandByIdWithHttpInfo($id);
        return $response;
    }
    ...
    public function deleteBrandByIdWithHttpInfo($id)
    {
        ...
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling deleteBrandById');
        }
        // parse inputs
    ...
    public function getBrandByIdWithHttpInfo($id, $includes = null, $limit = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling getBrandById');
        }
        // parse inputs
        $resourcePath = "/brands/{id}/";
        $httpBody = '';
    ...
    {
        list($response) = $this->updateBrandsByIdWithHttpInfo($id, $brand);
        return $response;
    }
    ...
    public function updateBrandsByIdWithHttpInfo($id, $brand)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling updateBrandsById');
        }
        // verify the required parameter 'brand' is set
        if ($brand === null) {
            throw new \InvalidArgumentException('Missing the required parameter $brand when calling updateBrandsById');
        }
        // parse inputs
        $resourcePath = "/brands/{id}/";
        $httpBody = '';
