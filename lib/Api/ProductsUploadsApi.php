...
/**
 * ProductsUploadsApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class ProductsUploadsApi
{
    ...
    {
        list($response) = $this->getProductImagesWithHttpInfo($id);
        return $response;
    }
    ...
    {
        list($response) = $this->getProductImagesByIdWithHttpInfo($id, $id_image);
        return $response;
    }
     ...
     * @param  \SplFileObject $image File for product (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\InlineResponse20012
    ...
    {
        list($response) = $this->uploadProductsImagesWithHttpInfo($id, $image);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadProductsImagesAsync($id, $image = null)
    {
        return $this->uploadProductsImagesAsyncWithHttpInfo($id, $image)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function uploadProductsImagesRequest($id, $image = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
