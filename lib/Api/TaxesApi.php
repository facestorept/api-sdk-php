...
class TaxesApi
{
     ...
     * @return \Swagger\Client\Model\InlineResponse2012
     */
    public function updateTaxById_0($id, $tax)
    {
        list($response) = $this->updateTaxById_0WithHttpInfo($id, $tax);
        return $response;
    }

    /**
     * Operation updateTaxById_0WithHttpInfo
     *
     * @param  int $id ID of tax to update (required)
     * @param  \Swagger\Client\Model\Tax $tax Tax to add to the store (required)
     *
     ...
     * @return array of \Swagger\Client\Model\InlineResponse2012, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateTaxById_0WithHttpInfo($id, $tax)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2012';
        $request = $this->updateTaxById_0Request($id, $tax);
    ...
    /**
     * Operation updateTaxById_0Async
     *
     * 
     *
     * @param  int $id ID of tax to update (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateTaxById_0Async($id, $tax)
    {
        return $this->updateTaxById_0AsyncWithHttpInfo($id, $tax)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateTaxById_0AsyncWithHttpInfo
     *
     * 
     *
     * @param  int $id ID of tax to update (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateTaxById_0AsyncWithHttpInfo($id, $tax)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2012';
        $request = $this->updateTaxById_0Request($id, $tax);
    ...
    /**
     * Create request for operation 'updateTaxById_0'
     *
     * @param  int $id ID of tax to update (required)
     * @param  \Swagger\Client\Model\Tax $tax Tax to add to the store (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateTaxById_0Request($id, $tax)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling updateTaxById_0'
            );
        }
        // verify the required parameter 'tax' is set
        if ($tax === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $tax when calling updateTaxById_0'
            );
        }
