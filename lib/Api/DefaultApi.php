...
class DefaultApi
{
    ...
    {
        $this->nullWithHttpInfo();
    }

    /**
     * Operation nullWithHttpInfo
     *
     * null
     *
     *
     ...
     */
    public function nullWithHttpInfo()
    {
        $returnType = '';
        $request = $this->nullRequest();
     ...
     */
    public function nullAsync()
    {
        return $this->nullAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation nullAsyncWithHttpInfo
     *
     * null
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function nullAsyncWithHttpInfo()
    {
        $returnType = '';
        $request = $this->nullRequest();
    ...
    /**
     * Create request for operation 'null'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function nullRequest()
    {
