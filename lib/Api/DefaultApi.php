...
class DefaultApi
{
     ...
     * @param  map[string,string] $image_larger Larger image for brand (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function uploadImages($id, $image_small = null, $image_larger = null)
    {
        $this->uploadImagesWithHttpInfo($id, $image_small, $image_larger);
    }
     ...
     */
    public function uploadImagesWithHttpInfo($id, $image_small = null, $image_larger = null)
    {
        $returnType = '';
        $request = $this->uploadImagesRequest($id, $image_small, $image_larger);
     ...
     */
    public function uploadImagesAsync($id, $image_small = null, $image_larger = null)
    {
        return $this->uploadImagesAsyncWithHttpInfo($id, $image_small, $image_larger)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadImagesAsyncWithHttpInfo($id, $image_small = null, $image_larger = null)
    {
        $returnType = '';
        $request = $this->uploadImagesRequest($id, $image_small, $image_larger);
     ...
     */
    protected function uploadImagesRequest($id, $image_small = null, $image_larger = null)
    {
        ...
        // form params
        if ($image_larger !== null) {
            $formParams['image_larger'] = ObjectSerializer::toFormValue($image_larger);
        }
        // body params
        $_tempBody = null;
